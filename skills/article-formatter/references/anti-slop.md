# Anti-slop rules — full reference

Bundled within article-formatter. Apply per the mode rules in SKILL.md.
Active for Mode A (writing) and Mode B (flagging). Detection-only for Mode C.
